...
export class InventoryService {
	...
	getPlannedMaterials(projectId: number): Observable<PlannedResource[]> {
		const params = new HttpParams().set('projectId', projectId.toString());
		return this.http.get<PlannedResource[]>(`${this.apiUrl}/planned-materials`, { params });
	}
	...
	downloadInventoryReport(projectId: number): Observable<Blob> {
		return this.http.get(`${environment.apiUrl}/projects/${projectId}/reports/inventario`, {
			responseType: 'blob',
		});
	}
}
