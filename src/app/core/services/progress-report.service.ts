...
export class ProgressReportService {
	...
	getReportsByProject(
	...
	): Observable<GroupedProgressReportDto[]> {
		...
		return this.http.get<GroupedProgressReportDto[]>(`${this.apiUrl}/project/${projectId}`, {
			params,
		});
	}
	...
	downloadProgressReport(projectId: number, filters?: ProgressReportFilters): Observable<Blob> {
		...
		return this.http.get(`${environment.apiUrl}/projects/${projectId}/reports/avances`, {
			params,
			responseType: 'blob',
		});
	}
